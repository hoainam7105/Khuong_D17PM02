...
namespace KtraGiuaKy.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            var category = db.Category.Include(p => p.Product);
            if (!String.IsNullOrEmpty(searchString))
            {
                category = category.Where(s => s.Name.ToUpper().Contains(searchString.ToUpper()) || s.Note.ToUpper().Contains(searchString.ToUpper()));
            }
